...
-(id)init
{
    if(self = [super init]) {
        ...
        [windowController setWindowFrameAutosaveName:@"shelfnativeMacOSX"];
...
- (void)setUpApplicationMenu
{
    ...
    [rootMenu addItemWithTitle:@"Quit shelfnativeMacOSX" action:@selector(terminate:) keyEquivalent:@"q"];
