...
const {Alert, AppRegistry, StyleSheet} = ReactNative;
...
class shelfnativeMacOSX extends Component {
    constructor(props) {
        super(props);
        this.state = {
            connected: false,
...
reactMixin(shelfnativeMacOSX.prototype, TimerMixin);

AppRegistry.registerComponent('shelfnativeMacOSX', () => shelfnativeMacOSX);
